// ============================================================
// 2GM Booking v14.0.7 — app.js (Core)
...
async function saveBooking(){
  ...
  // BISECT v14.0.7 — minimal payload for diagnosis
  const fields={Person_Name:name,Company:company,RoomLookupId:room?Number(room.id):undefined};
  console.log('[BISECT] Minimal payload test:',JSON.parse(JSON.stringify(fields)));
